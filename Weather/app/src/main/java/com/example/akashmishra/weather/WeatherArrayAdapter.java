...
class WeatherArrayAdapter extends ArrayAdapter<Weather> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        else { // reuse existing viewholder stored as the list item tag
        ...
        viewHolder.dayTextView.setText(context.getText(R.string.day_description, day.dayOfWeek, day.description));
        viewHolder.lowTextView.setText(context.getText(R.string.low_temp, day.minTemp));
        viewHolder.hiTextView.setText(context.getText(R.string.high_temp, day.maxTemp));
        viewHolder.humidityTextView.setText(context.getText(R.string.humidity, day.humidity));
    ...
    // Async task to weather condition icon in a separate thread
